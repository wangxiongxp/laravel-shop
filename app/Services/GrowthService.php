...
class GrowthService
{
    ...
    {
        $this->PrimaryKey = "id";
        $this->TableName  = 'growth';
    }

    public function queryGrowth($arrData)
    {
        $draw       = $arrData['draw'] ;
    ...
    {
        return Growth::where('id', '=', $id)->first();
    }

    public function insertGrowth($arrData)
    {
        return Growth::create($arrData);
    }

    public function updateGrowth($arrData)
    {
        $id = $arrData['id'];
        return Growth::where('id','=',$id)->update($arrData);
    }

    public function deleteGrowth($id)
    {
        return Growth::where('id', '=', $id)->delete();
    }
