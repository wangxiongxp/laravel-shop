...
class MessageService
{
    ...
    public function queryMessage($arrData)
    {
        $draw       = $arrData['draw'] ;
        ...
        if(!empty($keyword)){
            $query->where('msg_detail','like', '%'.$keyword.'%');
        }
    ...
    {
        return Message::where('msg_id', '=', $msg_id)->first();
    }

    public function insertMessage($arrData)
    {
        return Message::create($arrData);
    }

    public function updateMessage($arrData)
    {
        $msg_id = $arrData['msg_id'];
        return Message::where('msg_id','=',$msg_id)->update($arrData);
    }

    public function deleteMessage($msg_id)
    {
        return Message::where('msg_id', '=', $msg_id)->delete();
    }
