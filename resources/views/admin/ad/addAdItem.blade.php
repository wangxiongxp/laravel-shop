                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" id="ad_item_title" name="ad_item_title" placeholder="" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-2 control-label">广告链接<span class="required" ></span></label>
                                            <div class="col-md-4">
                                                <input type="text" id="ad_item_href" name="ad_item_href" placeholder="" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-2 control-label">广告图片<span class="required" ></span></label>
                                            <div class="col-md-8">
                                                <input type="hidden" id="ad_item_path" name="ad_item_path" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <textarea id="ad_item_desc" name="ad_item_desc" placeholder="" class="form-control"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-2 control-label">排序<span class="required" >*</span></label>
                                            <div class="col-md-4">
                                                <input type="text" id="ad_item_sort" name="ad_item_sort" placeholder="" class="form-control">
                                            </div>
                                        </div>
...
@section('foot_script')
    <script type="text/javascript">
            ...
            if(data){
                if(data.code == 1)
                {
                    WX.toastr({'type':'success','message':'保存成功.','onHidden':function(){
                        location.href = "/admin/adItem?id={{$ad_id}}";
                    }});
                }else{
        ...
        function Function_SaveForm(){
            $("#AddForm").attr('action','/admin/adItem/save');
            $("#AddForm").submit();
        }
    </script>
