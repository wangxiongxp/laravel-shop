            ...
            <div class="col-md-12">
                ...
                <div class="portlet light bordered" id="form_wizard_1">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject bold uppercase"> 新增刮刮乐</span>
                        </div>
                        <div class="actions">
                        </div>
                    </div>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane active" id="tab1">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="hidden" id="award_id" name="award_id" value="{{$item->award_id}}" />
                                                    <input type="hidden" id="award_type" name="award_type" value="{{$item->award_type}}" />
                                                    <input type="text" id="award_name" name="award_name" value="{{$item->award_name}}" placeholder="" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="input-group date form_datetime">
                                                        <input type="text" id="start_time" name="start_time" value="{{$item->start_time}}" readonly class="form-control">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="input-group date form_datetime">
                                                        <input type="text" id="end_time" name="end_time" value="{{$item->end_time}}" readonly class="form-control">
                                                        <span class="input-group-btn">
                                                            <button class="btn default date-set" type="button">
                                                                <i class="fa fa-calendar"></i>
                                                            </button>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <textarea id="award_desc" name="award_desc" placeholder="" class="form-control">{{$item->award_desc}}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tab-pane" id="tab2">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" id="cost_point" name="cost_point" value="{{$item->cost_point}}" placeholder="" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">参与送积分<span class="required" >*</span></label>
                                                <div class="col-md-6">
                                                    <input type="text" id="give_point" name="give_point" value="{{$item->give_point}}" placeholder="" class="form-control">
                                        ...
                                        <div class="tab-pane" id="tab3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" id="probability" name="probability" value="{{$item->probability}}" placeholder="" class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <textarea id="failed_desc" name="failed_desc" placeholder="" class="form-control">{{$item->failed_desc}}</textarea>
                                                </div>
                                            </div>
...
@section('foot_script')
    ...
    <script>
        $(function(){
            ...
            SetChecked('give_point_to_loser','{{$item->give_point_to_loser}}');
            SetRadioSelected('time_limit','{{$item->time_limit}}');
            App.updateUniform();
...
//                }
            ...
            $('#form_wizard_1 .button-submit').click(function () {
                $("#submit_form").attr('action','/admin/award/update');
                $("#submit_form").submit();
            }).hide();
