            ...
            <!-- Begin: life time stats -->
                ...
                <div class="portlet-title">
                    <div class="caption font-dark">
                        <span class="caption-subject bold uppercase"> 刮刮乐</span>
                    </div>
                    <div class="actions">
...
@section('foot_script')
    ...
    <script type="text/javascript" >
        ...
        $(document).ready(function(){
            ...
            grid.setAjaxParam('award_type','1');
            grid.init({
                src: $("#data_tables"),
                dataTable: {
                    "columns":cols,
        ...
        function GridClickFunction_Add(){
            var url = '/admin/award/cards?act=add';
            location.href = url;
        }

        function GridClickFunction_Edit(item){
            var id = item.award_id;
            var url = "/admin/award/cards?act=edit&id="+id;
            location.href = url;
        }
