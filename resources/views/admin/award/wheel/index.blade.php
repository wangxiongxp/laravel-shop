                ...
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            <span class="caption-subject bold uppercase"> 幸运大抽奖</span>
                        </div>
                        <div class="actions">
...
@section('foot_script')
    ...
    <script type="text/javascript" >
        ...
        $(document).ready(function(){
            ...
            grid.setAjaxParam('award_type','2');
        ...
        function GridClickFunction_Add(){
            var url = '/admin/award/wheel?act=add';
            location.href = url;
        }

        function GridClickFunction_Edit(item){
            var id = item.award_id;
            var url = "/admin/award/wheel?act=edit&id="+id;
            location.href = url;
        }
