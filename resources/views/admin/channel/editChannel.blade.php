                ...
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            <span class="caption-subject bold uppercase"> 编辑频道</span>
                        </div>
                    </div>
                            ...
                            <div class="form-body" style="padding-top:30px;">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" id="channel_title" name="channel_title" value="{{$item->channel_title}}" placeholder="" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-2 control-label">频道摘要<span class="required" >&nbsp;</span></label>
                                    <div class="col-md-6">
                                        <textarea id="channel_summary" name="channel_summary" placeholder="" class="form-control">{{$item->channel_summary}}</textarea>
                                    </div>
                                </div>
                                    ...
                                    <div  class="col-md-10" >
                                        <div class="radio-list ">
                                            <label class="radio-inline">
                                                <input type="radio" name="channel_status" id="channel_status_1" value="1" />开启
                                            </label>
                                            <label class="radio-inline">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" id="channel_sort" name="channel_sort" value="{{$item->channel_sort}}" placeholder="" class="form-control">
                                    </div>
                                </div>
...
@section('foot_script')
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            ajaxSelectSimple('/admin/productCat/getCatalogByParent/0','category_id','cat_id','cat_title','{{$item->category_id}}');
            SetRadioSelected('channel_status','{{$item->channel_status}}')
            App.initUniform();
        ...
        function Function_Save(){
            $("#AddForm").attr('action','/admin/channel/update');
            $("#AddForm").submit();
        }
