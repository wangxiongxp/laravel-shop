                ...
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <div class="btn-group btn-group-devided" >
                            ...
                            <label onclick="location.href='/admin/coupon'" class="btn btn-transparent dark btn-outline btn-circle btn-sm">
...
@section('foot_script')
    ...
    <script type="text/javascript" >
        ...
        $(document).ready(function(){
            ...
            grid.init({
                ...
                dataTable: {
                    "columns":cols,
                    "ajax": {
                        "url": "/admin/coupon/queryGoods/{{$coupon_id}}",
                    },
                    "order": [
                    ]
                }
        ...
        function GridClickFunction_Add(){
            var url = '/admin/coupon/selectGoods';
        ...
        function GridClickFunction_Delete(item){
            WX.Confirm('确定要删除么？',function(){
                var url = "/admin/coupon/deleteGoodsById/"+item.id;
