...
<script>
    ...
    $(document).ready(function(){
        ...
        grid_product.setAjaxParam('coupon_id',$("#coupon_id").val());
        grid_product.init({
            src: $("#product_tables"),
            dataTable: {
                "columns":cols_product,
                "ajax": {
                    "url": "/admin/coupon/querySelectGoods",
                },
                "order": [
                    [6, "desc"]
                ]
    ...
    function Function_SaveProduct(){
        ...
        var url = "/admin/coupon/saveCouponGoods"
        ...
        AjaxAction({'url':url,'method':"POST", 'data':{ids:ids,coupon_id:coupon_id}, 'success':function(data){
            if(data.code == 1) {
