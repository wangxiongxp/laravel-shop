                ...
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            <span class="caption-subject bold uppercase"> 编辑友情链接</span>
                        </div>
                    </div>
                        ...
                        <form role="form" class="form-horizontal" method="post" id="AddForm" action="">
                            <div class="form-body" style="padding-top:30px;">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="hidden" id="link_id" name="link_id" value="{{$item->link_id}}">
                                        <input type="text" id="link_title" name="link_title" value="{{$item->link_title}}" placeholder="" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-2 control-label">链接地址<span class="required" >*</span></label>
                                    <div class="col-md-4">
                                        <input type="text" id="link_href" name="link_href" value="{{$item->link_href}}" placeholder="" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-2 control-label">链接图片<span class="required" ></span></label>
                                    <div class="col-md-4">
                                        <input type="hidden" id="link_image" name="link_image" value="{{$item->link_image}}">
                                        <a class="btn btn-default" id="select_image">选择图片</a>
                                        @if(!empty($item->link_image))
                                            <img src="{{$item->link_image}}" style="width:32px;"/>
                                        @else
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <textarea id="link_desc" name="link_desc" placeholder="" class="form-control">{{$item->link_desc}}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-2 control-label">排序<span class="required" >*</span></label>
                                    <div class="col-md-4">
                                        <input type="text" id="link_sort" name="link_sort" value="{{$item->link_sort}}" placeholder="" class="form-control">
                                    </div>
                                </div>
...
@section('foot_script')
    ...
    <script type="text/javascript">
        ...
        function Function_Save(){
            $("#AddForm").attr('action','/admin/friendLink/update');
            $("#AddForm").submit();
        }
