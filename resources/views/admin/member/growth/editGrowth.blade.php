                ...
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase"> 编辑会员等级</span>
                        </div>
                    </div>

                    <div class="portlet-body form">
                        <form role="form" class="form-horizontal" method="post" id="EditForm" action="/admin/growth/update">
                            <div class="form-body" style="padding-top:30px;">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" id="min_growth" name="min_growth" value="{{$item->min_growth}}" placeholder="" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" id="max_growth" name="max_growth" value="{{$item->max_growth}}" placeholder="" class="form-control">
                                    </div>
                                </div>
