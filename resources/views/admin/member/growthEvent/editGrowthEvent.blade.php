                ...
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold uppercase"> 编辑积分规则</span>
                        </div>
                    </div>

                    <div class="portlet-body form">
                        <form role="form" class="form-horizontal" method="post" id="EditForm" action="/admin/growthEvent/update">
                            <div class="form-body" style="padding-top:30px;">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" id="code" name="code" value="{{$item->code}}" placeholder="" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" id="growth" name="growth" value="{{$item->growth}}" placeholder="" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control form-control-inline input-medium date-picker" id="start_time" name="start_time" type="text" value="{{$item->start_time}}" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control form-control-inline input-medium date-picker" id="end_time" name="end_time" type="text" value="{{$item->end_time}}" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <textarea id="remark" name="remark" value="" placeholder="" class="form-control">{{$item->remark}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="checkbox" id="status" name="status" @if($item->status==1) checked @endif class="make-switch" data-on-color="warning" data-off-color="danger">
                                    </div>
                                </div>
