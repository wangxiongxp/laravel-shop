                ...
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            <span class="caption-subject bold uppercase"> 编辑导航</span>
                        </div>
                    </div>
                        ...
                        <form role="form" class="form-horizontal" method="post" id="AddForm" action="">
                            <div class="form-body" style="padding-top:30px;">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="hidden" id="nav_id" name="nav_id" value="{{$item->nav_id}}" >
                                        <input type="text" id="nav_title" name="nav_title" value="{{$item->nav_title}}" placeholder="" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-2 control-label">导航链接<span class="required" >&nbsp;</span></label>
                                    <div class="col-md-4">
                                        <input id="nav_path" name="nav_path" value="{{$item->nav_path}}" placeholder="" class="form-control" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div  class="col-md-10" >
                                        <div class="radio-list ">
                                            <label class="radio-inline">
                                                <input type="radio" name="nav_status" id="nav_status_1" value="1" />开启
                                            </label>
                                            <label class="radio-inline">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" id="nav_sort" name="nav_sort" value="{{$item->nav_sort}}" placeholder="" class="form-control">
                                    </div>
                                </div>
...
@section('foot_script')
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            SetRadioSelected('nav_status','{{$item->nav_status}}')
            App.initUniform();

            ajaxSelectSimple('/admin/navigation/getFirstNav','parent_id','nav_id','nav_title','{{ $item->parent_id}}');

            $("#nav_type").val('{{ $item->nav_type}}');
        ...
        function Function_Save(){
            $("#AddForm").attr('action','/admin/navigation/update');
            $("#AddForm").submit();
        }
