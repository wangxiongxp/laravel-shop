                ...
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            <span class="caption-subject bold uppercase"> 新增页面</span>
                        </div>
                    </div>

                    <div class="portlet-body form">
                        <form role="form" class="form-horizontal" method="post" id="EditForm" action="/admin/page/save">
                            <div class="form-body" style="padding-top:30px;">

                                <div class="form-group">
                                    <label class="col-md-2 control-label">自定义Url<span class="required" ></span></label>
                                    <div class="col-md-10">
                                        <input type="text" id="page_url" name="page_url" value="" placeholder="" class="form-control input-medium input-inline">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" id="page_name" name="page_name" value="" placeholder="" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <textarea id="page_summary" name="page_summary" value="" placeholder="" class="form-control"></textarea>
                                    </div>
                                </div>
