...
@section('foot_script')
    ...
    <script type="text/javascript" >
        ...
        $(document).ready(function(){
            var cols = [
                {data:'brand_id',name:'brand_id',orderable:false,createdCell:function(cell, cellData, rowData, rowIndex, colIndex){
                    $(cell).html(rowIndex+1)} },
                {data:'brand_name',name:'brand_name',orderable:true,searchable:true,visible:true,render:function(val){
                    return val} },
                {data:'brand_code',name:'brand_code',orderable:true,searchable:true,visible:true,render:function(val){
                    return val} },
                {data:'brand_desc',name:'brand_desc',orderable:false,searchable:true,render:function(val){
                    return val}},
                {data:'brand_sort',name:'brand_sort',orderable:true,searchable:true,render:function(val){
                    return val}},
        ...
        function GridClickFunction_Edit(item){
            ...
            var url = "/admin/brand?act=edit&id="+brand_id;
            $.ajax({
                type: "GET",
                url: url,
                dataType: 'html',
        ...
        function GridClickFunction_Delete(item){
            ...
            WX.Confirm('确定要删除么？',function(){
                var url = "/admin/brand/delete/"+brand_id;
