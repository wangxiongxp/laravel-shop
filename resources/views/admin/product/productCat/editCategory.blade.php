            ...
            <form id="AddForm" method="post" role="form" class="form-horizontal">
                <div class="form-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <select class="form-control" id="cat_parent" disabled="disabled" name="cat_parent">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" id="cat_title" name="cat_title" value="{{ $cat->cat_title}}" placeholder="" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">分类图片<span class="required" ></span></label>
                        <div class="col-md-8">
                            <input type="hidden" id="cat_image" name="cat_image" value="{{$cat->cat_image}}">
                            <a class="btn btn-default" id="select_image">选择图片</a>
                            @if(!empty($cat->cat_image))
                                <img src="{{$cat->cat_image}}" style="width:32px;"/>
                            @else
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" id="cat_sort" name="cat_sort" value="{{ $cat->cat_sort}}" placeholder="" class="form-control">
                        </div>
                    </div>
                </div>
            </form>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ajaxSelectSimple('/admin/productCat/getFirstCategory','cat_parent','cat_id','cat_title','{{ $cat->cat_parent}}');
        var setting = {
            rules: {
                cat_parent: {
                    required: true
    ...
    function Function_SaveForm(){
        $("#AddForm").attr('action','/admin/productCat/update');
        $("#AddForm").submit();
    }
</script>
