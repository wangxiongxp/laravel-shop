            ...
            <form id="AddForm" method="post" role="form" class="form-horizontal">
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" id="attr_name" name="attr_name" placeholder="" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" id="attr_sort" name="attr_sort" placeholder="" class="form-control">
                        </div>
                    </div>
                </div>
            </form>
...
<script type="text/javascript">
    ...
    function Function_SaveForm(){
        $("#AddForm").attr('action','/admin/productCatAttr/save');
        $("#AddForm").submit();
    }
</script>