            ...
            <form id="AddForm" method="post" role="form" class="form-horizontal">
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="hidden" id="option_id" name="option_id" value="{{ $option->option_id}}" >
                            <input type="text" id="option_name" name="option_name" value="{{ $option->option_name}}" placeholder="" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">排序<span class="required" >*</span></label>
                        <div class="col-md-6">
                            <input type="text" id="option_sort" name="option_sort" value="{{ $option->option_sort}}" placeholder="" class="form-control">
                        </div>
                    </div>
                </div>
            </form>
...
<script type="text/javascript">
    ...
    function Function_SaveForm(){
        $("#AddForm").attr('action','/admin/productCatAttrOption/update');
        $("#AddForm").submit();
    }
</script>