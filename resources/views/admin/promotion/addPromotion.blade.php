                ...
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            <span class="caption-subject bold uppercase"> 新增促销活动</span>
                        </div>
                    </div>
                        ...
                        <form role="form" class="form-horizontal" method="post" id="AddForm" action="">
                            <div class="form-body" style="padding-top:30px;">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" id="prom_name" name="prom_name" placeholder="" class="form-control">
                                    </div>
                                </div>
                                    ...
                                    <div  class="col-md-10" >
                                        <div class="radio-list ">
                                            <label class="radio-inline">
                                                <input type="radio" name="prom_scope" value="all" />A类券（所有商品）
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="prom_scope" value="category" />C类券（分类优惠）
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="prom_scope" value="brand" />B类券（品牌优惠）
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="prom_scope" value="goods" />S类券（指定商品）
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <table class="table table-bordered" >
                                            <tr role="row" >
                                                <td style="border-bottom: none">
                                                    <div class="radio-list">
                                                        <label >
                                                            <input name="buy_cond" value="1" type="radio"> 满
                                                            <input type="text" id="min_price" name="min_price" class="form-control input-inline input-small"> 元
                                                        </label>
                                                    </div>
                                                </td>
                                                <td style="border-bottom: none">
                                                    <div class="radio-list">
                                                        <label >
                                                            <input name="prom_type" value="1" type="radio"> 减金额
                                                            <input type="text" id="minus" name="minus" class="form-control input-inline input-small"> 元
                                                        </label>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr role="row" >
                                                <td style="border-top: none;border-bottom: none">
                                                    <div class="radio-list">
                                                        <label >
                                                            <input name="buy_cond" value="2" type="radio"> 满
                                                            <input type="text" id="min_num" name="min_num" class="form-control input-inline input-small"> 件
                                                        </label>
                                                    </div>
                                                </td>
                                                <td style="border-top: none;border-bottom: none">
                                                    <div class="radio-list">
                                                        <label >
                                                            <input name="prom_type" value="2" type="radio"> 打折
                                                            <input type="text" id="discount" name="discount" class="form-control input-inline input-small"> 折
                                                        </label>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr role="row" >
                                                <td style="border-top: none">
                                                    <div class="radio-list">
                                                        <label >
                                                            <input name="buy_cond" value="3" type="radio"> 无需条件
                                                        </label>
                                                    </div>
                                                </td>
                                                <td style="border-top: none">
                                                    <div class="radio-list">
                                                        <label >
                                                            <input name="prom_type" value="3" type="radio"> 包邮
                                                        </label>
                                                    </div>
                                                </td>
                                            </tr>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <textarea id="prom_desc" name="prom_desc" placeholder="" class="form-control"></textarea>
                                    </div>
                                </div>
...
@section('foot_script')
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            SetRadioSelected('prom_scope','all');
            SetRadioSelected('buy_cond','1');
            SetRadioSelected('prom_type','1');
            App.initUniform();
            ...
            $("input[name='prom_scope']").change(function(){
        ...
        function Function_Save(){
            ...
            $("#AddForm").attr('action','/admin/promotion/save');
            $("#AddForm").submit();
        }
