...
<script>
    ...
    $(document).ready(function(){
        ...
        grid_product.setAjaxParam('prom_id',$("#prom_id").val());
        grid_product.init({
            src: $("#product_tables"),
            dataTable: {
                "columns":cols_product,
                "ajax": {
                    "url": "/admin/promotion/querySelectGoods",
                },
                "order": [
                    [6, "desc"]
                ]
    ...
    function Function_SaveProduct(){
        ...
        var url = "/admin/promotion/savePromotionGoods"
        ...
        AjaxAction({'url':url,'method':"POST", 'data':{ids:ids,prom_id:prom_id}, 'success':function(data){
            if(data.code == 1) {
