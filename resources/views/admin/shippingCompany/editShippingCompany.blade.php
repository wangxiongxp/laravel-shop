                ...
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            <span class="caption-subject bold uppercase"> 编辑物流公司</span>
                        </div>
                    </div>
                        ...
                        <form id="AddForm" method="post" role="form" class="form-horizontal">
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="hidden" id="company_image" name="company_image" value="{{$item->company_image}}" >
                                        <a class="btn btn-default" id="select_image">选择图片</a>
                                        @if(!empty($item->company_image))
                                            <img src="{{$item->company_image}}" style="width:32px;"/>
                                        @else
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" id="company_name" name="company_name" value="{{$item->company_name}}" placeholder="" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-2 control-label">排序<span class="required" >*</span></label>
                                    <div class="col-md-4">
                                        <input type="text" id="company_sort" name="company_sort" value="{{$item->company_sort}}" placeholder="" class="form-control">
                                    </div>
                                </div>
...
@section('foot_script')
    ...
    <script>
        ...
        function Function_SaveForm(){
            $("#AddForm").attr('action','/admin/shippingCompany/update');
            $("#AddForm").submit();
        }
