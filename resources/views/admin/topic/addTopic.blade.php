                ...
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            <span class="caption-subject bold uppercase"> 新增专题</span>
                        </div>
                    </div>
                        ...
                        <form id="AddForm" method="post" role="form" class="form-horizontal">
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" id="topic_title" name="topic_title" placeholder="" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <textarea id="topic_summary" name="topic_summary" placeholder="" class="form-control"></textarea>
                                    </div>
                                </div>
                                    ...
                                    <div  class="col-md-10" >
                                        <div class="radio-list ">
                                            <label class="radio-inline">
                                                <input type="radio" name="topic_status" id="topic_status_1" value="1" checked="checked" />显示
                                            </label>
                                            <label class="radio-inline">
...
@section('foot_script')
    ...
    <script>
        ...
        function Function_SaveForm(){
            ...
            $("#AddForm").attr('action','/admin/topic/save');
            $("#AddForm").submit();
        }
