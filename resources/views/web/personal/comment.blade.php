...
@section('assets_head')
	...
	<link href="/assets/front/css/cmstyle.css" rel="stylesheet" type="text/css">
@endsection
											...
											<li class="td td-item">
												<div class="item-pic">
													<a href="#" class="J_MakePoint">
														<img src="/assets/front/images/kouhong.jpg_80x80.jpg" class="itempic">
													</a>
												</div>
											</li>
									...
									<div class="comment-list">
										<ul class="item-list">
											...
											<li class="td td-comment">
												...
												<div class="item-comment">
													宝贝非常漂亮，超级喜欢！！！ 口红颜色很正呐，还有第两支半价，买三支免单一支的活动，下次还要来买。就是物流太慢了，还要我自己去取快递，店家不考虑换个物流么？
													<div class="filePic"><img src="/assets/front/images/image.jpg" alt=""></div>
												</div>
