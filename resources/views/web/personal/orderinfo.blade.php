...
@section('assets_head')
	...
	<link href="/assets/front/css/orstyle.css" rel="stylesheet" type="text/css">
@endsection
				...
				<div class="user-orderinfo">
					...
					<div class="order-infoaside">
						<div class="order-logistics">
							<a href="/logistics">
								<div class="icon-log">
									<i><img src="/assets/front/images/receive.png"></i>
								</div>
									...
									<div class="order-left">
										...
										<ul class="item-list">
											<li class="td td-item">
												<div class="item-pic">
													<a href="#" class="J_MakePoint">
														<img src="/assets/front/images/62988.jpg_80x80.jpg" class="itempic J_ItemImg">
													</a>
												</div>
												<div class="item-info">
													<div class="item-basic-info">
