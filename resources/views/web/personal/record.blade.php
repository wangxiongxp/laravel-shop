...
@section('assets_head')
	...
	<link href="/assets/front/css/refstyle.css" rel="stylesheet" type="text/css">
@endsection
					...
					<div class="record-aside">
						<div class="item-pic">
							<a href="#" class="J_MakePoint">
								<img src="/assets/front/images/comment.jpg_400x400.jpg" class="itempic">
							</a>
						</div>
